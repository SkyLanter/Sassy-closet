...
`kit.sh save` rebuilds the one hub (`out/sassycloset.xlsx`) from the live export. `kit.sh books` rebuilds empty Square.xlsx + Finance.xlsx. Do not add pink sheets or embedded photos to “make it nicer.”
