...
> **Origin APPLY (this shop):** Boss override — Add A03+ **Saves** and shows on Message-to-buy; rename extras OK with uniqueness. Do **not** apply O1 (kill Add / `/m/A03` 404) or O15 (rename closed). See [32-admin-matrix-apply.md](./32-admin-matrix-apply.md). Excel stays read-only. P02 / P05 Hold. Kelly Ying look lock.
